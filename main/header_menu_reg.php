  ...
  <nav class="nav_menu">
    <ul class="ancho">
      <li><a href="menu_registro.php">REGISTRO</a></li>
      ...
      <li><a href="../user/config.php">CONFIGURACIÓN</a></li>
      <li><a href="cerrarsesion.php" onclick="return confirm('¿Estás seguro de que desea salir?')">Salir</a></li>
    </ul>
  </nav>